...
display_name_dict = {
    ...
    "sva": "SVA",
    "fact-retrieval": "Country-Capital",
    "hypernymy": "Hypernymy",
}
...
ylabel = fig.text(
    -0.00, 0.5, "Normalized faithfulness", va="center", rotation="vertical", fontsize=12
)
fig.tight_layout()
fig.savefig(
    f"{model}/png/real-pareto.png",
